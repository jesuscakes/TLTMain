...
// Main settings
define('SITE_NAME', 'TheLoadingTimes'); //The name of your site
...
define('SITE_IP', '23.23.152.195'); //The IP address by which your site can be publicly accessed
...
// Keys
define('ENCKEY', 'ineQzWptU3FlmEoqz70IOAbbiHolWM4WooW5GGTVeeDMYJnGpxFOk6ZYsiK3'); //Random key. The key for encryption
define('SITE_SALT', 'JdN71IRa8r1pTpeiEbkGNYeseW0R6NmVOmfatB1N'); //Random key. Default site wide salt for passwords, DO NOT LEAVE THIS BLANK/CHANGE AFTER LAUNCH!
define('SCHEDULE_KEY', '7L7Sch3du13'); // Random key. This key must be the argument to schedule.php for the schedule to work.
define('RSS_HASH', 'slNLbEBuln9MJwI2oAmFtUWzzRQOckIMW127KIMy'); //Random key. Used for generating unique RSS auth key.

// MySQL details
define('SQLHOST', 'localhost'); //The MySQL host ip/fqdn
define('SQLLOGIN', 'gazelle');//The MySQL login
define('SQLPASS', '7yr10n!!$$'); //The MySQL password
...
define('TRACKER_SECRET', '98SEne3AbAqeStEsPecraPhUSpuBR9h6'); // Must be 32 characters and match site_password in Ocelot's config.cpp
